...
- **AC anchoring + accuracy documentation**
  (`docs/architecture/superposition_module.md` §10). The estimate is AC-anchored: both the
...
- `docs/architecture/superposition_module.md`: §10 GST documentation (AC anchoring,
