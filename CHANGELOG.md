...
- See `docs/design/antenna_overflow_graph.md`. Tests in `tests/test_antenna_graph.py`.
...
- **Docs**: `docs/design/superposition_module.md` §10 now documents the AC-anchoring of
...
- **Library-side contract documentation** (`docs/design/recommender_models.md`, PR #90): step-by-step guide to writing a third-party recommender — minimal ABC implementation, registry pattern, DTO field reference, capability flags, integration with the reassessment phase.
...
- **Design and quality documents** (PR #71, PR #77): `docs/design/renewable_curtailment_design.md` (algorithm, scoring, data requirements) and `docs/notes/code-quality-analysis.md` (static analysis snapshot: god-module inventory, testing gaps, TODO/FIXME catalogue).
